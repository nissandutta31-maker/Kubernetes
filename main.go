...
import (
	...
	"github.com/nissandutta31-maker/kubernetes/controllers"
)
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "runtime-operator.nvidia.com",
	})
	if err != nil {
	...
	if err = (&controllers.RuntimePackageReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "RuntimePackage")
		os.Exit(1)
	}
	...
	setupLog.Info("starting nvidia-runtime-operator")
